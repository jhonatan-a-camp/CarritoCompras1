...
<div class="container">
    <div class="row">
        <table style="background-color:#CCE5FF" class="table table-striped  table-inverse table-responsive">
            ...
            <tfoot>
                <tr>
                    ...
                    <th><?php echo $_SESSION['VALORES']["SUBTOTAL"] ?> </th>
                </tr>
                <tr>
                    <th colspan="4"> Iva</th>
                    <th><?php echo $_SESSION['VALORES']["IVA"] ?> </th>
                </tr>
                <tr>
                    <th colspan="4"> Apagar</th>
                    <th><?php echo $_SESSION['VALORES']["APAGAR"] ?> </th>
                </tr>
            </tfoot>
        </table>
        <div class="col-md-9">
        ...
        <div class="col-md-3">
            <a class="btn btn-warning" href="index.php">Regresar a ver un produto</a>
